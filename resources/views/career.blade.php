...
@section('title', 'Career available from Webshop Technology')
@section('description', "Join our team & let's work together. Explore the available job vacancies")
@section('keywords', "job, job portal, jobs, vacancies, need a job, team, freelance, fiverr, upwork, 
freelancers, remote, work, web, webshop, shop, tech, technology, client, featured, portfolio, afrovending, 
aafinilu, printivo, work, result, featured, deliveries, oratorio, oratoriogroup, mehome, me4u, meride, 
mattpeelogistics, elim-santurary, olusolaadebayo, fishvillae, digital, solution, problem, services, 
webshop, software, engineering, frontend, backend, design, development, craft, game, web, website, technology")
@section('canonical', 'https://webshoptechnology.com/career')
@section('main')
<main>
