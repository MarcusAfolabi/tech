...
@section('title', 'All our thoughts')
@section('description', "Crafting new bright brands, unique visual systems and digital experience focused on a wide range of original collabs.")
@section('keywords', 'support, blog, articules, writing, tech, crafting, bright, write, help, web, webshop, shop, tech, technology, client, featured, portfolio, afrovending, aafinilu, printivo, work, result, featured, deliveries, oratorio, oratoriogroup, mehome, me4u, meride, mattpeelogistics, elim-santurary, olusolaadebayo, fishvillae, digital, solution, problem, services, webshop, software, engineering, frontend, backend, design, development, craft, game, web, website, technology')
@section('canonical', 'https://webshoptechnology.com/support')
@section('main')
      <main>
        <!-- Blog area start -->
